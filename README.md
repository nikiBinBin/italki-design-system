...
The Catalog is no longer mapped to Panda: the generated Panda/API reference documents were removed. The underlying mapping data is still in `catalog-runtime/contracts.json`, dormant.
