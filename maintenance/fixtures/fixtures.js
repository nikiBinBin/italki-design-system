  ...
  function build(ui) {
    ...
    const entries = {
      ...
      selection: [
        ...
        fixture("selection", "avatar-default", ui.selection({ label: "Olivia Rhye", contentType: "avatar", leading: '<img src="Assets/Icons/user.svg" alt="" />', description: "Product Manager" })),
      ...
      card: [
        ...
        fixture("card", "media", ui.card({ media: "Assets/Icons/user.svg", mediaAlt: "Profile placeholder", title: "Weekly learning plan", body: "<p>Media is supplied by the parent.</p>" })),
      ...
      upload: [
        ...
        fixture("upload", "avatar-filled", ui.upload({ id: "fixture-upload-avatar-filled", variant: "avatar", label: "Profile photo", avatar: "Assets/Icons/user.svg", avatarAlt: "Elena Ruiz profile photo" })),
        fixture("upload", "avatar-uploading", ui.upload({ id: "fixture-upload-avatar-uploading", variant: "avatar", label: "Profile photo", avatar: "Assets/Icons/user.svg", state: "uploading" })),
