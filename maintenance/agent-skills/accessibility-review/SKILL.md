...
Check the resolved value of the semantic role in **both** themes
(`{KIT}/guidelines/COMPONENTS.md § Light And Dark Semantic Mapping`), not the hex you see in
one screenshot. Baselines: `§ Accessibility Baseline`; touch targets:
`{KIT}/guidelines/EXECUTION.md § 13.2 Touch Targets`; motion:
